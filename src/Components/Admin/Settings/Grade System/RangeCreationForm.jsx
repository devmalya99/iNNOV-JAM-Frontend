...
import { createRange } from '../../../../services/gradingApis/gradingApi';

const RangeCreationForm = () => {

    const { grades,ranges, setRanges ,setOpenForm, setGradeName, gradeId, rangeStart, setRangeStart, rangeEnd, setRangeEnd, label, setLabel} = userGradeStore();
