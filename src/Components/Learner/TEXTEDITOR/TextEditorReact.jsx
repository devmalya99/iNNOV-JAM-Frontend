...
export function TextEditorReact() {
  ...
  return (
    <LexicalComposer initialConfig={editorConfig}>
      <div className="relative  overflow-hidden my-5 w-full rounded-xl border border-gray-300 bg-white text-left font-normal h-full leading-5 text-gray-900">
        <ToolbarPlugin />
        <div className="relative rounded-b-lg border-opacity-5 bg-white">
          <RichTextPlugin
            contentEditable={
              <ContentEditable className="lexical h-[calc(100vh-550px)] resize-none px-2.5 py-4 text-base caret-gray-900 outline-none" />
            }
            onChange={(content) => {
              console.log(content);
            }}
